...
export class SidebarMenuService {
    ...
    private mainMenu: SidebarMenuElement[] = [
        ...
        SidebarMenuElement.builder()
            .setName(Paths.BS_PROJECT.name)
            .setPath(Paths.BS_PROJECT.path)
            .setIcon(this.iconService.faAddressCard)
            .setNeedBusinessLoaded(true)
            .setShowWithBusinessLoaded(true)
            .setCanActiveRoles([
                userRole.ADMIN,
    ...
    unloadBusiness(): void {
        let roles: String[] = [userRole.ADMIN, userRole.CLIENT];
