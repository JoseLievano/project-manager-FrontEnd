...
export class BusinessService extends ModelService<Business> {
    ...
    protected override pageListViewRestrictions(pageRequest: PageRequest) {
        if (this.actualUser != null || this.actualUser != undefined) {
            /*console.log('Actual role', this.actualUser);*/
            // @ts-ignore
    ...
    public getLoadedBusiness(): number {
        let actualBusiness: number = JSON.parse(
            <string>window.localStorage.getItem('business'),
        );
        if (actualBusiness >= 0) {
    ...
    protected override getViewKeys(): ViewKey[] {
        ...
        return [
            ViewKeyBuilder.builder()
                .setPrivateKeyName('id')
                .setPublicKeyName('ID')
                .setAccessRole(commonRoles),
            ViewKeyBuilder.builder()
                .setPrivateKeyName('name')
                .setPublicKeyName('Name')
                .setAccessRole(commonRoles),
            ViewKeyBuilder.builder()
                .setPrivateKeyName('taxID')
                .setPublicKeyName('Tax ID')
                .setAccessRole(commonRoles),
            ViewKeyBuilder.builder()
                .setPrivateKeyName('dateCreated')
                .setPublicKeyName('Date')
                .setAccessRole(commonRoles),
            ViewKeyBuilder.builder()
                .setPrivateKeyName('pendingInvoice')
                .setPublicKeyName('Pending Invoice')
                .setAccessRole(commonRoles),
            ViewKeyBuilder.builder()
                .setPrivateKeyName('overDue')
                .setPublicKeyName('Overdue')
                .setAccessRole(commonRoles),
            ViewKeyBuilder.builder()
                .setPrivateKeyName('isActive')
                .setPublicKeyName('Active')
                .setAccessRole(commonRoles),
            ViewKeyBuilder.builder()
                .setPrivateKeyName('client')
                .setPublicKeyName('Client')
                .setAccessRole(commonRoles),
            ViewKeyBuilder.builder()
                .setPrivateKeyName('invoices')
                .setPublicKeyName('Invoices')
                .setAccessRole(commonRoles),
            ViewKeyBuilder.builder()
                .setPrivateKeyName('plan')
                .setPublicKeyName('Plan')
                .setAccessRole(commonRoles),
            ViewKeyBuilder.builder()
                .setPrivateKeyName('bsClients')
                .setPublicKeyName('Clients')
                .setAccessRole(commonRoles),
            ViewKeyBuilder.builder()
                .setPrivateKeyName('bsDocs')
                .setPublicKeyName('Docs')
                .setAccessRole(commonRoles),
            ViewKeyBuilder.builder()
                .setPrivateKeyName('bsDocsCategories')
                .setPublicKeyName('Docs Categories')
                .setAccessRole(commonRoles),
            ViewKeyBuilder.builder()
                .setPrivateKeyName('bsEmployees')
                .setPublicKeyName('Employees')
                .setAccessRole(commonRoles),
            ViewKeyBuilder.builder()
                .setPrivateKeyName('bsInvoices')
                .setPublicKeyName('Customer Invoices')
                .setAccessRole(commonRoles),
            ViewKeyBuilder.builder()
                .setPrivateKeyName('bsKBCategories')
                .setPublicKeyName('KB Categories')
                .setAccessRole(commonRoles),
            ViewKeyBuilder.builder()
                .setPrivateKeyName('bsKBs')
                .setPublicKeyName('KBs')
                .setAccessRole(commonRoles),
            ViewKeyBuilder.builder()
                .setPrivateKeyName('bsManagers')
                .setPublicKeyName('Managers')
                .setAccessRole(commonRoles),
            ViewKeyBuilder.builder()
                .setPrivateKeyName('bsPriorities')
                .setPublicKeyName('Priorities')
                .setAccessRole(commonRoles),
            ViewKeyBuilder.builder()
                .setPrivateKeyName('bsStatuses')
                .setPublicKeyName('Statuses')
                .setAccessRole(commonRoles),
            ViewKeyBuilder.builder()
                .setPrivateKeyName('bsTaskCategories')
                .setPublicKeyName('Task Categories')
                .setAccessRole(commonRoles),
            ViewKeyBuilder.builder()
                .setPrivateKeyName('bsTypes')
                .setPublicKeyName('Types')
                .setAccessRole(commonRoles),
            ViewKeyBuilder.builder()
                .setPrivateKeyName('bsProjects')
                .setPublicKeyName('Projects')
                .setAccessRole(commonRoles),
            ViewKeyBuilder.builder()
                .setPrivateKeyName('bsPrTasks')
                .setPublicKeyName('Tasks')
                .setAccessRole(commonRoles),
        ];
    }
